...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post resumes_url, params: { resume: { attachment: @resume.attachment, name: @resume.name } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { attachment: @resume.attachment, name: @resume.name } }
